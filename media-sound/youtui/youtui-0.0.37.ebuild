...
CRATES="
	...
	yoke-derive@0.8.2
	youtui@0.0.37
	youtui-vendored-rusty_ytdl@0.7.4-youtui-vendored.4
	ytmapi-rs@0.3.2
	zbus@3.15.2
	zbus_macros@3.15.2
	zbus_names@2.6.1
...
pkg_postinst() {
	elog "Consider trying media-sound/smoc avaiable in the same overlay as this ebuild."
	elog "https://github.com/mrazza/smoc"
}
